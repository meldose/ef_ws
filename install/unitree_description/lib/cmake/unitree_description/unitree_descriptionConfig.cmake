...
if(NOT unitree_description_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${unitree_description_FIND_COMPONENTS})
    if(NOT "unitree_description_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("unitree_description_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("UNITREE_DESCRIPTION_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("unitree_description_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/unitree_description/doxygen-html")
set("UNITREE_DESCRIPTION_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/unitree_description/doxygen-html")
set("unitree_description_DEPENDENCIES" "")
set("unitree_description_PKG_CONFIG_DEPENDENCIES" "")
...
set("_unitree_description_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_unitree_description_PKG_CONFIG_LIBS_LIST" "")
if(_unitree_description_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_unitree_description_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _unitree_description_PKG_CONFIG_LIBS_LIST "${_unitree_description_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_unitree_description_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _unitree_description_PKG_CONFIG_LIBS_LIST "${_unitree_description_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_unitree_description_PKG_CONFIG_LIBDIR})
  foreach(component ${_unitree_description_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_unitree_description_PKG_CONFIG_LIBS_LIST)

set("unitree_description_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("UNITREE_DESCRIPTION_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${unitree_description_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/unitree_descriptionTargets.cmake")
...
foreach(component ${unitree_description_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(unitree_description_${component}_FOUND FALSE)
  endif()
  if(unitree_description_${component}_FOUND)
    message(STATUS "unitree_description: ${component} found.")
  else()
    if(unitree_description_FIND_REQUIRED_${component})
      message(FATAL_ERROR "unitree_description: ${component} not found.")
    else()
      message(STATUS "unitree_description: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("unitree_description")
